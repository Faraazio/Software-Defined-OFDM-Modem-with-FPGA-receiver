...
4. **IFFT**: The frequency-domain vector is transformed to time domain using an inverse fast Fourier transform (IFFT), resulting in 64 complex time samples.

5. **Cyclic prefix insertion**: The last 16 time samples are copied and prepended to form an 80-sample OFDM symbol.

6. **Preamble generation**:
